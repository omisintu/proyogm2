<?php
namespace MGS\Mpanel\Controller\Adminhtml\Cms\Page;
...
class Save extends \Magento\Cms\Controller\Adminhtml\Page\Save
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if(isset($data['page_title_background']) && is_array($data['page_title_background'])){
                $data['page_title_background']=$data['page_title_background'][0]['name'];
            }
