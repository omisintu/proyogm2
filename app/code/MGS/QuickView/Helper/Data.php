...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    \Magento\Catalog\Model\Product $product, $ratio = NULL
    ) {
        $result = '';
        ...
        if ($isEnabled) {
            ...
            return $result . '<button data-title="'. __("Quick View") .'" class="action mgs-quickview" data-ratio="'. $ratio .'" data-quickview-url=' . $productUrl . '"><span class="pe-7s-search"></span></button>';
        }
        return $result;
    }
